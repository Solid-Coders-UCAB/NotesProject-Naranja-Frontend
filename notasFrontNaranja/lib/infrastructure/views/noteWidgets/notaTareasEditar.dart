...
class NotaTareasEditar extends StatefulWidget {
  List<tarea> tasks = [];
  HtmlEditorEditExampleState home;

  NotaTareasEditar({super.key, required this.tasks, required this.home});

  @override
  State<NotaTareasEditar> createState() => NotaTareasEditarState(tasks: tasks, home: home);
}

class NotaTareasEditarState extends State<NotaTareasEditar> {
  List<tarea> tasks = [];
  HtmlEditorEditExampleState home;
  NotaTareasEditarState({required this.tasks, required this.home});
